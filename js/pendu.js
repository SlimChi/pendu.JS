let dictionnaire = ["chenille","ABOMINERONS ","ACCOMMODEES ","VULNERANTES ", "lucarne", "horloge", "loup", "paysan", "squelette", "voleur", "jacques", "angers", "poste", "triste", "frissons", "pirate", "corps", "olympique", "orange", "erreur", "parfumerie", "dossier", "soulever", "dessin", "crayon", "robinet", "ananas", "scientifique", "abeille", "planeur", "collectionneur", "farine", "pie", "hormones", "annoncer", "echarpe", "bouton", "cerveau", "porte", "poisson", "naviguer", "arbre", "table", "froid", "antibiotiques", "poitiers", "paris", "nantes", "chantez", "tribunal", "gramme", "singulier","AFFECTIONNASSIONS ","CIRCONSTANCIERAIT ","abélianisée","bredouillis","capitularde","cadenassais","daltonienne","matoub","lounas","samy","rebh","bouira","cylindrerai","damasquiner"]
